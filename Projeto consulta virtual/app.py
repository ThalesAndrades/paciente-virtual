...
from consulta.exames import verificar_exames
from consulta.exame_fisico import verificar_exame_fisico
...
while True:
    ...
    # ==========================
    # MOTOR DE EXAME FÍSICO
    # ==========================

    if verificar_exame_fisico(
        texto,
        caso,
        arquivo_historico,
        voz
