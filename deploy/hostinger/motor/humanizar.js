...
export function sistemaPaciente(caso) {
  ...
  return [
    ...
    "",
    "REGRA MAIS IMPORTANTE — TAMANHO. Isto aqui é uma conversa FALADA: o profissional",
    "vai OUVIR a sua resposta. Responda em 1 ou 2 frases curtas, como se estivesse",
    "falando, não escrevendo. Um parágrafo leva meio minuto para ser ouvido e faz a",
    "consulta parar. Ninguém responde a 'como a senhora está?' com cinco frases.",
    "Só se estenda quando pedirem explicitamente ('me conta mais', 'como assim?') —",
    "e mesmo aí, no máximo 3 ou 4 frases.",
